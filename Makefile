...
40image-6: 40image.o compress40.o decompress40.o a2plain.o brightness.o chromacity.o matrix_mult.o uarray2.o compress_struct.o decompress_struct.o convert_signed_unsigned.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
